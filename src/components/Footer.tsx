        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://instagram.com/chileflor.cl" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800 hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 hover:text-white transition-all text-gray-300">
                ...
                <span className="font-medium text-sm">@chileflor.cl</span>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="/club" className="hover:text-primary transition-colors">Club Chileflor Beneficios</a></li>
              <li><a href="/mi-cuenta" className="hover:text-primary transition-colors">Mi Comunidad (CRM)</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contacto@chileflor.cl" className="hover:text-primary transition-colors">contacto@chileflor.cl</a>
              </li>
              <li className="pt-2">
