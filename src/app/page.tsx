...
// ── Componente: Banner Raspe y Gana ──
function RaspeBanner() {
  return (
    <section className="container mx-auto px-4 py-8 reveal">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-rose-700 via-pink-600 to-red-600 p-8 md:p-14 text-white shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10 border-4 border-rose-400/30">
        ...
        {/* Decoraciones de fondo floral/festivo */}
        <div className="absolute top-0 right-0 w-full h-full opacity-20 pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] mix-blend-overlay"></div>
        <div className="absolute -left-20 -bottom-20 w-64 h-64 bg-white/20 rounded-full blur-3xl animate-blob"></div>
        <div className="absolute right-10 top-10 w-40 h-40 bg-yellow-300/40 rounded-full blur-2xl animate-pulse"></div>
        ...
        {/* Gráfico de la tarjeta Raspe y Gana */}
        <div className="relative z-10 flex-shrink-0 w-64 h-64 md:w-80 md:h-96 hidden sm:flex items-center justify-center perspective-1000">
           
           {/* Tarjeta de fondo (girada) */}
           ...
           <div className="relative w-[220px] h-[320px] bg-gradient-to-br from-rose-100 to-pink-50 rounded-3xl shadow-2xl rotate-6 transform hover:rotate-2 hover:scale-105 transition-all duration-500 border-8 border-white overflow-hidden flex flex-col p-4 relative group cursor-pointer">
             
             {/* Textura fondo tarjeta */}
             <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-rose-400 via-transparent to-transparent"></div>
             ...
             <div className="w-full text-center relative z-10 mb-4">
                <h4 className="text-transparent bg-clip-text bg-gradient-to-b from-yellow-400 to-yellow-600 font-black text-3xl italic tracking-tighter drop-shadow-sm leading-none" style={{ textShadow: '1px 1px 0 #b45309, 2px 2px 2px rgba(0,0,0,0.2)' }}>
                  ¡RASPA
                </h4>
                <h4 className="text-transparent bg-clip-text bg-gradient-to-b from-yellow-400 to-yellow-600 font-black text-3xl italic tracking-tighter drop-shadow-sm leading-none -mt-1" style={{ textShadow: '1px 1px 0 #b45309, 2px 2px 2px rgba(0,0,0,0.2)' }}>
                  Y GANA!
                </h4>
             </div>
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50/50">
      ...
      {/* Info Slider (Configurable en CRM) */}
      ...
      {/* Banner de Experiencia (Conócenos) */}
